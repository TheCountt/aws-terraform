...
resource "aws_acm_certificate_validation" "project_demo_validation" {
  certificate_arn         = aws_acm_certificate.project_demo_cert.arn
  validation_record_fqdns = [for record in aws_route53_record.project_demo_record : record.fqdn]
}
